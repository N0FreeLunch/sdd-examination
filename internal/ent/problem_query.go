...
type ProblemQuery struct {
	...
	withUnit         *UnitQuery
	withVersions     *VersionRuleQuery
	withTranslations *ProblemTranslationQuery
	withParent       *ProblemQuery
	withChildren     *ProblemQuery
...
func (_q *ProblemQuery) QueryUnit() *UnitQuery {
...
func (_q *ProblemQuery) QueryVersions() *VersionRuleQuery {
...
func (_q *ProblemQuery) QueryTranslations() *ProblemTranslationQuery {
...
func (_q *ProblemQuery) QueryParent() *ProblemQuery {
...
func (_q *ProblemQuery) QueryChildren() *ProblemQuery {
	query := (&ProblemClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
...
func (_q *ProblemQuery) WithUnit(opts ...func(*UnitQuery)) *ProblemQuery {
	query := (&UnitClient{config: _q.config}).Query()
...
func (_q *ProblemQuery) WithVersions(opts ...func(*VersionRuleQuery)) *ProblemQuery {
	query := (&VersionRuleClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *ProblemQuery) WithTranslations(opts ...func(*ProblemTranslationQuery)) *ProblemQuery {
	query := (&ProblemTranslationClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *ProblemQuery) WithParent(opts ...func(*ProblemQuery)) *ProblemQuery {
	query := (&ProblemClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *ProblemQuery) WithChildren(opts ...func(*ProblemQuery)) *ProblemQuery {
	query := (&ProblemClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *ProblemQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Problem, error) {
	...
	if query := _q.withUnit; query != nil {
		if err := _q.loadUnit(ctx, query, nodes, nil,
			func(n *Problem, e *Unit) { n.Edges.Unit = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withVersions; query != nil {
		if err := _q.loadVersions(ctx, query, nodes,
			func(n *Problem) { n.Edges.Versions = []*VersionRule{} },
			func(n *Problem, e *VersionRule) { n.Edges.Versions = append(n.Edges.Versions, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withTranslations; query != nil {
		if err := _q.loadTranslations(ctx, query, nodes,
			func(n *Problem) { n.Edges.Translations = []*ProblemTranslation{} },
			func(n *Problem, e *ProblemTranslation) { n.Edges.Translations = append(n.Edges.Translations, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withParent; query != nil {
		if err := _q.loadParent(ctx, query, nodes, nil,
			func(n *Problem, e *Problem) { n.Edges.Parent = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withChildren; query != nil {
		if err := _q.loadChildren(ctx, query, nodes,
			func(n *Problem) { n.Edges.Children = []*Problem{} },
			func(n *Problem, e *Problem) { n.Edges.Children = append(n.Edges.Children, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *ProblemQuery) loadUnit(ctx context.Context, query *UnitQuery, nodes []*Problem, init func(*Problem), assign func(*Problem, *Unit)) error {
...
func (_q *ProblemQuery) loadVersions(ctx context.Context, query *VersionRuleQuery, nodes []*Problem, init func(*Problem), assign func(*Problem, *VersionRule)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(versionrule.FieldProblemID)
	}
	query.Where(predicate.VersionRule(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(problem.VersionsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		fk := n.ProblemID
		if fk == nil {
			return fmt.Errorf(`foreign-key "problem_id" is nil for node %v`, n.ID)
		}
		node, ok := nodeids[*fk]
		if !ok {
...
func (_q *ProblemQuery) loadTranslations(ctx context.Context, query *ProblemTranslationQuery, nodes []*Problem, init func(*Problem), assign func(*Problem, *ProblemTranslation)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*Problem)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(problemtranslation.FieldProblemID)
	}
	query.Where(predicate.ProblemTranslation(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(problem.TranslationsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *ProblemQuery) loadParent(ctx context.Context, query *ProblemQuery, nodes []*Problem, init func(*Problem), assign func(*Problem, *Problem)) error {
	ids := make([]int, 0, len(nodes))
	nodeids := make(map[int][]*Problem)
	for i := range nodes {
...
func (_q *ProblemQuery) loadChildren(ctx context.Context, query *ProblemQuery, nodes []*Problem, init func(*Problem), assign func(*Problem, *Problem)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*Problem)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(problem.FieldParentID)
	}
	query.Where(predicate.Problem(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(problem.ChildrenColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *ProblemQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withUnit != nil {
			_spec.Node.AddColumnOnce(problem.FieldUnitID)
		}
		if _q.withParent != nil {
			_spec.Node.AddColumnOnce(problem.FieldParentID)
		}
	}
