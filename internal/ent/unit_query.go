...
func (_q *UnitQuery) QueryExam() *ExamQuery {
...
func (_q *UnitQuery) QuerySection() *SectionQuery {
...
func (_q *UnitQuery) QueryTopic() *TopicQuery {
...
func (_q *UnitQuery) QueryProblems() *ProblemQuery {
...
func (_q *UnitQuery) WithExam(opts ...func(*ExamQuery)) *UnitQuery {
	query := (&ExamClient{config: _q.config}).Query()
...
func (_q *UnitQuery) WithSection(opts ...func(*SectionQuery)) *UnitQuery {
	query := (&SectionClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *UnitQuery) WithTopic(opts ...func(*TopicQuery)) *UnitQuery {
	query := (&TopicClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *UnitQuery) WithProblems(opts ...func(*ProblemQuery)) *UnitQuery {
	query := (&ProblemClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *UnitQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Unit, error) {
	...
	if query := _q.withExam; query != nil {
		if err := _q.loadExam(ctx, query, nodes, nil,
			func(n *Unit, e *Exam) { n.Edges.Exam = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withSection; query != nil {
		if err := _q.loadSection(ctx, query, nodes, nil,
			func(n *Unit, e *Section) { n.Edges.Section = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withTopic; query != nil {
		if err := _q.loadTopic(ctx, query, nodes, nil,
			func(n *Unit, e *Topic) { n.Edges.Topic = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withProblems; query != nil {
		if err := _q.loadProblems(ctx, query, nodes,
			func(n *Unit) { n.Edges.Problems = []*Problem{} },
			func(n *Unit, e *Problem) { n.Edges.Problems = append(n.Edges.Problems, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *UnitQuery) loadExam(ctx context.Context, query *ExamQuery, nodes []*Unit, init func(*Unit), assign func(*Unit, *Exam)) error {
...
func (_q *UnitQuery) loadSection(ctx context.Context, query *SectionQuery, nodes []*Unit, init func(*Unit), assign func(*Unit, *Section)) error {
	ids := make([]int, 0, len(nodes))
	nodeids := make(map[int][]*Unit)
	for i := range nodes {
...
func (_q *UnitQuery) loadTopic(ctx context.Context, query *TopicQuery, nodes []*Unit, init func(*Unit), assign func(*Unit, *Topic)) error {
	ids := make([]int, 0, len(nodes))
	nodeids := make(map[int][]*Unit)
	for i := range nodes {
		if nodes[i].TopicID == nil {
			continue
		}
		fk := *nodes[i].TopicID
		if _, ok := nodeids[fk]; !ok {
...
func (_q *UnitQuery) loadProblems(ctx context.Context, query *ProblemQuery, nodes []*Unit, init func(*Unit), assign func(*Unit, *Problem)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(problem.FieldUnitID)
	}
	query.Where(predicate.Problem(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(unit.ProblemsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *UnitQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withExam != nil {
			_spec.Node.AddColumnOnce(unit.FieldExamID)
		}
		if _q.withSection != nil {
			_spec.Node.AddColumnOnce(unit.FieldSectionID)
		}
		if _q.withTopic != nil {
			_spec.Node.AddColumnOnce(unit.FieldTopicID)
		}
	}
