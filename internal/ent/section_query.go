...
func (_q *SectionQuery) QueryExam() *ExamQuery {
...
func (_q *SectionQuery) QueryTopics() *TopicQuery {
...
func (_q *SectionQuery) QueryUnits() *UnitQuery {
...
func (_q *SectionQuery) WithExam(opts ...func(*ExamQuery)) *SectionQuery {
	query := (&ExamClient{config: _q.config}).Query()
...
func (_q *SectionQuery) WithTopics(opts ...func(*TopicQuery)) *SectionQuery {
	query := (&TopicClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *SectionQuery) WithUnits(opts ...func(*UnitQuery)) *SectionQuery {
	query := (&UnitClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *SectionQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Section, error) {
	...
	if query := _q.withExam; query != nil {
		if err := _q.loadExam(ctx, query, nodes, nil,
			func(n *Section, e *Exam) { n.Edges.Exam = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withTopics; query != nil {
		if err := _q.loadTopics(ctx, query, nodes,
			func(n *Section) { n.Edges.Topics = []*Topic{} },
			func(n *Section, e *Topic) { n.Edges.Topics = append(n.Edges.Topics, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withUnits; query != nil {
		if err := _q.loadUnits(ctx, query, nodes,
			func(n *Section) { n.Edges.Units = []*Unit{} },
			func(n *Section, e *Unit) { n.Edges.Units = append(n.Edges.Units, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *SectionQuery) loadExam(ctx context.Context, query *ExamQuery, nodes []*Section, init func(*Section), assign func(*Section, *Exam)) error {
...
func (_q *SectionQuery) loadTopics(ctx context.Context, query *TopicQuery, nodes []*Section, init func(*Section), assign func(*Section, *Topic)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(topic.FieldSectionID)
	}
	query.Where(predicate.Topic(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(section.TopicsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *SectionQuery) loadUnits(ctx context.Context, query *UnitQuery, nodes []*Section, init func(*Section), assign func(*Section, *Unit)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*Section)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(unit.FieldSectionID)
	}
	query.Where(predicate.Unit(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(section.UnitsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *SectionQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withExam != nil {
			_spec.Node.AddColumnOnce(section.FieldExamID)
		}
	}
