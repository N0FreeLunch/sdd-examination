...
// The ProblemTranslationFunc type is an adapter to allow the use of ordinary
// function as ProblemTranslation mutator.
type ProblemTranslationFunc func(context.Context, *ent.ProblemTranslationMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f ProblemTranslationFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.ProblemTranslationMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.ProblemTranslationMutation", m)
}
...
// The VersionRuleFunc type is an adapter to allow the use of ordinary
// function as VersionRule mutator.
type VersionRuleFunc func(context.Context, *ent.VersionRuleMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f VersionRuleFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.VersionRuleMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.VersionRuleMutation", m)
}
